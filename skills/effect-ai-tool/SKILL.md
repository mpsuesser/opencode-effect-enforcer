...
### Alternative: Handlers as ServiceMap
...
- Similar to toLayer but returns a `ServiceMap` instead of Layer
- Use when you need direct handler context (not Layer composition)
- Returns `Effect<ServiceMap<Handlers>>`
...
class WeatherService extends ServiceMap.Service<
	WeatherService,
	{
...
5. **toHandlers** - Implement handlers returning ServiceMap

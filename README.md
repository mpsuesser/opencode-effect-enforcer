...
- [front-depiction/claude-setup](https://github.com/front-depiction/claude-setup) — The original Claude Code config that enforced Effect v3 patterns with a lighter touch, this was originally a fork of that
- [kriegcloud/beep-effect](https://github.com/kriegcloud/beep-effect/blob/main/standards/effect-first-development.md) — The original for what is presently the [docs/effect-first-development.md](/docs/effect-first-development.md) guidance document injected at the top of each session
- [Kit Langton](https://github.com/anomalyco/opencode/pulls?q=is%3Apr+author%3Akitlangton+effect) — Seeing to the effectful divination of OpenCode meanwhile publishing artisinal real-world Effect code from which this plugin and others like it will surely benefit in perpetuity amen

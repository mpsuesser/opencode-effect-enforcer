...
-- named type, constructor, instanceof, annotations
```
...
`Schema.Struct` produces an anonymous schema without a constructor or `instanceof` support. `Schema.Class` provides a named type, constructor, extensibility, and annotation support. Prefer `Schema.Class` for all domain/object schemas.
